...
3. **Publishing the Integrated Release**
   ...
   | Repository         | Version         | Changelog                   | Release                    |
      | ------------------ | --------------- | --------------------------- | --------------------------- |
   | did-cli-tool-server   | V1.0.1    | [Changelog](https://github.com/OmniOneID/did-cli-tool-server/blob/main/CHANGELOG.md) |
   | ..                 | ..              | ..                           |
